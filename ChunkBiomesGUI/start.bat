...
cd build_server
cmake -G "MinGW Makefiles" -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -S ../server_source -B . 2>nul
mingw32-make
if %errorlevel% neq 0 (
 echo.
...
echo.
python ChunkBiomesGUI\seedfinder_server.py --dll-path build_server\seedfinder_lib.dll
pause
